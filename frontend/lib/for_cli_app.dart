...
// Version de consola del juego. Sirve para probar reglas, guardado y acciones
// basicas sin arrancar la interfaz Flutter.

import 'dart:io';
import 'package:for_core/core.dart';

/// Calcula un texto simple con el tamaño de la primera rotacion del edificio.
...
/// Resume en texto los requisitos de un monumento para la consola.
...
/// Intenta construir y muestra el error de reglas sin cerrar el programa.
void _intentarConstruir(
  ...
  try {
    game.construir(origin, building, rotationIdx, buildingIdx, isFromMonument);
  } on RuleError catch (error) {
    print('\n!! ${error.message}');
  }
}

/// Ejecuta una accion del juego capturando errores de reglas.
...
/// Arranca el bucle interactivo de consola.
void runForCli() {
